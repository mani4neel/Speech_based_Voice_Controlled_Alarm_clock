...
#include "stdafx.h"
#include<stdio.h.>
#include "Cepstral_Coefficients.h"
#include<cstdlib>
#include <string.h>
#include <fstream>
#include <sstream>
...
char words[5][10] = {     {'s', 'e', 't','_','a','l','a','r','m','\0'},
                         {'s', 't', 'o', 'p', '\0'},
                         {'s', 'n', 'o', 'o', 'z','e','\0'},
						 {'a','m','\0'},
						 {'p','m','\0'}
		...
		case 1:
			        option=0;
						...
						if(option==1)
						{
							...
							scanf("%s",&word);
							for(int file_cnt=16;file_cnt<=30;file_cnt++)
							{
